...
function FeedbackReport() {
  ...
  const columns = [
    ...
    // {
    //   field: "booking_status", // Leave it empty as we'll define the data in the body template
    //   header: "Booking Status",
    //   filterPlaceholder: "Search by Name",
    //   filterField: "booking_status",
    // },
    // {
    //   field: "payment_status", // Leave it empty as we'll define the data in the body template
  ...
  const exportPdf = () => {
    ...
    const totalPriceRow = exportColumns.map((col) => {
      return col.header === "Price" ? totalPrice : ""; // Only add total price to the "Price" column
    });
